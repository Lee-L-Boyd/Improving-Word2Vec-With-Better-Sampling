../bin/hadoop fs -rmr /user/mr/context_count_midway_span
../bin/hadoop jar ../contrib/streaming/hadoop-*streaming*.jar \
 ...
 -output /user/mr/context_count_midway_span
...
../bin/hadoop jar ../contrib/streaming/hadoop-*streaming*.jar \
 ...
 -file ~/hadoop-1.2.1/1_run_mr/m_echo.py \
 -mapper ~/hadoop-1.2.1/1_run_mr/m_echo.py \
 -file ~/hadoop-1.2.1/1_run_mr/r_context_count_final_span.py \
 -reducer ~/hadoop-1.2.1/1_run_mr/r_context_count_final_span.py \
 -input /user/mr/context_count_midway_span/part-* \
