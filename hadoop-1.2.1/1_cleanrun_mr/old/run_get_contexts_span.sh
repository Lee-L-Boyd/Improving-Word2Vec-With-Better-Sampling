...
../bin/hadoop jar ../contrib/streaming/hadoop-*streaming*.jar \
 ...
 -mapper ~/hadoop-1.2.1/1_run_mr/m_get_contexts_span.py \
 -file ~/hadoop-1.2.1/1_run_mr/m_get_contexts_span.py \
 -reducer ~/hadoop-1.2.1/1_run_mr/r_get_contexts_span.py \
 -file ~/hadoop-1.2.1/1_run_mr/r_get_contexts_span.py \
 -combiner ~/hadoop-1.2.1/1_run_mr/r_get_contexts_span.py \
