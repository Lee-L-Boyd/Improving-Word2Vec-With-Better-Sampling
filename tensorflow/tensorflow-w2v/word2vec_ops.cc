...
REGISTER_OP("SkipgramWord2vec")
    ...
    .Attr("pos_dist: float = 1e-1")
    .Attr("neg_dist: float = 1e-1")
    .Doc(R"doc(
Parses a text file and creates a batch of examples.

vocab_word: A vector of words in the corpus.
neg_freq: Frequencies of words used on negative sampling. Sorted in the non-ascending order.
...
examples: A vector of word ids.
labels: A vector of word ids.
neg_freq: The counts used to produced the distribution for negative sampling.
